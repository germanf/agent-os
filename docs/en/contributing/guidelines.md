...
See `specs/workflow.md` for complete details.
...
- All documentation must exist in both **English** and **Spanish**
- Documentation files must maintain identical structure across languages
- Use Markdown only (no HTML, no GitHub Wiki)
